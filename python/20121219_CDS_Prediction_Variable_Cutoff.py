...
## Usage: python ~/code/python/20121219_CDS_Prediction_Variable_Cutoff.py <INPUT> <ORF FASTA> <OUTPUT> <LEN FILE> <CUTOFF>
...
for line in open(sys.argv[1], 'r'):
	...
	iden = float(tokens[9])
	if (iden / eff_len < 0.5) or (eff_len / prot_len < cut_off):
		continue
	# 1-based
