...
## Usage: python ~/code/python/019d_Fastq_PE_Remove_Duplicates.py <FILE LIST 1> <FILENAME POSTFIX> <LOG FILE>

import sys
if len(sys.argv) < 4:
        raise SystemExit, 'use grep "##" ~/code/python/019d_Fastq_PE_Remove_Duplicates.py to get usage'
import os
...
for line in open(sys.argv[1], 'r'):
	...
	dupcount = 0
	while i < len(f1lines):
		fragment = f1lines[i][10:40] + f2lines[i][10:40]
